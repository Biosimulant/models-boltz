# Working implementation specification

ResultSource passes captured records. Acceptance recomputes checks from the exact requests and responses. AcceptedRanking suppresses rankings for failed acceptance. Credentials remain agent-side. Dependencies are pinned in model manifests.
